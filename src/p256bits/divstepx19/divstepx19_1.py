...
CONST_2P41 = mem64[pointer_tmp + BYTE_IDX_CONST_2P41]
CONST_2P62 = mem64[pointer_tmp + BYTE_IDX_CONST_2P62]

f = mem64[pointer_tmp + BYTE_IDX_f]
g = mem64[pointer_tmp + BYTE_IDX_g]
DELTA = mem64[pointer_tmp + BYTE_IDX_DELTA]
...
code += """
mem64[pointer_tmp + BYTE_IDX_FUV] = FUV
mem64[pointer_tmp + BYTE_IDX_GRS] = GRS
mem64[pointer_tmp + BYTE_IDX_DELTA] = DELTA
